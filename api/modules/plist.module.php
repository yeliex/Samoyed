...
class Plist extends Samoyed
{
    ...
    public function __construct()
    {
        ...
        // 获取搜索关键字
        if ($this->target == "search" && isset($_GET['keyword']) && $_GET['keyword'] != "") {
    ...
    public function defaultAction()
    {
        ...
        */
        ...
        if ($this->target == "search") {
            $sql .= "AND building_product.building_name LIKE '%".$this->keyword."%' OR building_product.building_address LIKE '%".$this->keyword."%' OR building_product.building_area LIKE '%".$this->keyword."%' ";
        }
...
//        if ($this->target == "search") {
//            $statement->bindParam(':keyword', $this->keyword);
//        }
        $statement->execute();

...
// Import requirement
require_once "config/soft.config.php";
require_once "config/db.config.php";
require_once "lib/api.db.connection.php";
require_once "lib/api.return.php";
require_once "lib/api.samoyedapp.house.php";
...
// 确定这个类的文件是否存在
$class_file_name = "./mods/" . lcfirst($class_name) . "." . "api.module.php";

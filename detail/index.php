            ...
            <div class="intro-wrapper">
                <div class="ui container">
                    <div class="intro title">
                        <h1><span class="bname"><!-- 建筑名字 --></span></h1>

                        <h2></h2>
                    </div>
                    <div class="intro info">
                        <h1><span></span> 元/平方米/天</h1>
                            ...
                            <div class="detail-units detail-item">
                                ...
                                <div class="units-list">
                                    <ul class="col">
                                        ...
                                        <!-- <ul> -->
                                        <!-- <li><span>户型1</span></li> -->
                                        <!-- <li><span>11</span> 平方米</li> -->
                                        <!-- <li><span>11</span> 元/天/平方米</li> -->
                                        <!-- <li>装修</li> -->
                                        <!-- <li><span><img src="../style/img/index-bg.jpg"></span></li> -->
                                        <!-- </ul> -->
                                        <!-- </li> -->
                                    </ul>
                                </div>
                                    ...
                                    <div class="img-list">
                                        <div class="ui medium images">
                                            ...
                                            <!-- <div class="ui segment">
                                                <div class="ui bottom attached label">图片1</div>
                                                <img class="ui image"
                                                     src="http://7xked6.com2.z0.glb.qiniucdn.com/default_detailbg_1.jpeg">
                                            </div> -->
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sixteen wide column">
                                    <div class="map-content">
                                        ...
                                        <div class="btn-wrapper">
                                            <div class="toggle">
                                                <div class="ui slider checkbox" tabindex="0" id="zoom-btn">
                                                    <input type="checkbox">
                                                    <label>地图缩放(<span>关</span>)</label>
                                                </div>
                                            </div>
...
<script type="text/javascript" data-desc="Dev">
    //<!--    // Example: 加载开始/完成-->
    ////<!--    $("#user_mail").append("<i class='lose icon'></i>");-->
    //
    <!--    $("#user_phone i").remove();-->
</script>
</body>

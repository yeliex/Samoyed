...
!function (e, n, i, t) {
    ...
    e.fn.modal = function (o) {
        ...
        return r.each(function () {
            var r, b, p, y, k, w, C, M, S, F = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), D = F.selector, H = F.className, T = F.namespace, A = F.error, x = "." + T, z = "module-" + T, O = e(this), q = e(F.context), E = O.find(D.close), j = this, N = O.data(z);
            S = {
                initialize: function () {
                    ...
                    var t = e(n);
                    i = e.isFunction(S[i]) ? S[i] : S.toggle, t.length > 0 ? (S.debug("Attaching modal events to element", n, i), t.off(x).on("click" + x, i)) : S.error(A.notFound, n)
                }, bind: {
                    events: function () {
                    ...
                    approve: function () {
                        ...
                        var t = e(n.target), o = t.closest(D.modal).length > 0, a = e.contains(i.documentElement, n.target);
                    ...
                    n = e.isFunction(n) ? n : function () {
                    }, S.debug("Hiding modal"), F.onHide.call(j), (S.is.animating() || S.is.active()) && (F.transition && e.fn.transition !== t && O.transition("is supported") ? (S.remove.active(), O.transition({
                        debug: F.debug,
                    ...
                    autofocus: function () {
                        if (F.autofocus) {
                            var e = O.filter(":input").filter(":visible"), n = e.filter("[autofocus]"), i = n.length > 0 ? n.first() : e.first();
                            i.length > 0 && i.focus()
                        }
                    }, clickaway: function () {

...
!function (e, t, n, i) {
    ...
    e.fn.form = function (t) {
        var r, o = e(this), a = o.selector || "", s = (new Date).getTime(), l = [], c = arguments[0], u = arguments[1], f = "string" == typeof c, d = [].slice.call(arguments, 1);
        return o.each(function () {
            var p, g, m, v, h, b, y, k, x, w, E, C, S, R, F, A, T, O, z = e(this), D = this, j = [], V = !1;
            O = {
                initialize: function () {
                    ...
                    O.verbose("Attaching form events"), z.on("submit" + A, O.validate.form).on("blur" + A, E.field, O.event.field.blur).on("click" + A, E.submit, O.submit).on("click" + A, E.reset, O.reset).on("click" + A, E.clear, O.clear), k.keyboardShortcuts && z.on("keydown" + A, E.field, O.event.field.keydown), p.each(function () {
                        ...
                        e(this).on(i + A, O.event.field.change)
                    })
                }, clear: function () {
                    p.each(function () {
                        var t = e(this), n = t.parent(), i = t.closest(g), r = i.find(E.prompt), o = t.data(w.defaultValue) || "", a = n.is(E.uiCheckbox), s = n.is(E.uiDropdown), l = i.hasClass(C.error);
                        l && (O.verbose("Resetting error on field", i), i.removeClass(C.error), r.remove()), s ? (O.verbose("Resetting dropdown value", n, o), n.dropdown("clear")) : a ? t.prop("checked", !1) : (O.verbose("Resetting field value", t, o), t.val(""))
                    })
                }, reset: function () {
                    p.each(function () {
                        var t = e(this), n = t.parent(), r = t.closest(g), o = r.find(E.prompt), a = t.data(w.defaultValue), s = n.is(E.uiCheckbox), l = n.is(E.uiDropdown), c = r.hasClass(C.error);
                        a !== i && (c && (O.verbose("Resetting error on field", r), r.removeClass(C.error), o.remove()), l ? (O.verbose("Resetting dropdown value", n, a), n.dropdown("restore defaults")) : s ? (O.verbose("Resetting checkbox value", n, a), t.prop("checked", a)) : (O.verbose("Resetting field value", t, a), t.val(a)))
                    })
                }, is: {
                    valid: function () {
                        var t = !0;
                        return O.verbose("Checking if form is valid"), e.each(x, function (e, n) {
                    ...
                    field: {
                        keydown: function (t) {
                            var n = e(this), i = t.which, r = {enter: 13, escape: 27};
                            i == r.escape && (O.verbose("Escape key pressed blurring field"), n.blur()), !t.ctrlKey && i == r.enter && n.is(E.input) && n.not(E.checkbox).length > 0 && (V || (n.one("keyup" + A, O.event.field.keyup), O.submit(), O.debug("Enter pressed on input submitting form")), V = !0)
                        }, keyup: function () {
                            V = !1
                        }, blur: function () {
                            var t = e(this), n = t.closest(g), i = O.get.validation(t);
                            n.hasClass(C.error) ? (O.debug("Revalidating field", t, i), O.validate.field(i)) : ("blur" == k.on || "change" == k.on) && O.validate.field(i)
                        }, change: function () {
                            var t = e(this), n = t.closest(g);
                            ("change" == k.on || n.hasClass(C.error) && k.revalidate) && (clearTimeout(O.timer), O.timer = setTimeout(function () {
                    ...
                    changeEvent: function (e, t) {
                        ...
                        if (e.isPlainObject(t)) {
                            var n = Object.keys(t), r = n.length > 0 ? t[n[0]].identifier !== i : !1;
                            r ? (k = e.extend(!0, {}, e.fn.form.settings, u), x = e.extend({}, e.fn.form.settings.defaults, t), O.error(k.error.oldSyntax, D), O.verbose("Extending settings from legacy parameters", x, k)) : (k = e.extend(!0, {}, e.fn.form.settings, t), x = e.extend({}, e.fn.form.settings.defaults, k.fields), O.verbose("Extending settings", x, k))
                        } else k = e.fn.form.settings, x = e.fn.form.settings.defaults, O.verbose("Using default form validation", x, k);
                        R = k.namespace, w = k.metadata, E = k.selector, C = k.className, S = k.error, F = "module-" + R, A = "." + R, T = z.data(F), O.refresh()
                    }, field: function (t) {
                        ...
                        var n;
                        return x ? (e.each(x, function (e, i) {
                        ...
                        var n = e.isArray(t) ? O.get.fields(t) : p, i = {};
                        return n.each(function (t, n) {
                            var r = e(n), o = (r.prop("type"), r.prop("name")), a = r.val(), s = r.is(E.checkbox), l = r.is(E.radio), c = -1 !== o.indexOf("[]"), u = s ? r.is(":checked") : !1;
                            if (o)if (c)if (o = o.replace("[]", ""), i[o] || (i[o] = []), s) {
                                if (!u)return O.debug("Omitted unchecked checkbox", r), !0;
                                i[o].push(a)
                    ...
                    prompt: function (t, n) {
                        var r = O.get.field(t), o = r.closest(g), a = o.children(E.prompt), s = 0 !== a.length;
                        n = "string" == typeof n ? [n] : n, O.verbose("Adding field error state", t), o.addClass(C.error), k.inline && (s || (a = k.templates.prompt(n), a.appendTo(o)), a.html(n[0]), s ? O.verbose("Inline errors are disabled, no inline error added", t) : k.transition && e.fn.transition !== i && z.transition("is supported") ? (O.verbose("Displaying error with css transition", k.transition), a.transition(k.transition + " in", k.duration)) : (O.verbose("Displaying error with fallback javascript animation"), a.fadeIn(k.duration)))
                    }, errors: function (e) {
                        O.debug("Adding form error messages", e), m.html(k.templates.error(e))
                    }
                }, remove: {
                    prompt: function (t) {
                        var n = O.get.field(t.identifier), r = n.closest(g), o = r.children(E.prompt);
                        r.removeClass(C.error), k.inline && o.is(":visible") && (O.verbose("Removing prompt for field", t), k.transition && e.fn.transition !== i && z.transition("is supported") ? o.transition(k.transition + " out", k.duration, function () {
                            o.remove()
                    ...
                    success: function () {
                        ...
                        p.each(function () {
                            var t = e(this), n = t.filter(E.checkbox).length > 0, i = n ? t.is(":checked") : t.val();
                        ...
                        e.isEmptyObject(t) || e.each(t, function (t, n) {
                            var i, r = O.get.field(t), o = r.parent(), a = e.isArray(n), s = o.is(E.uiCheckbox), l = o.is(E.uiDropdown), c = r.is(E.radio) && s, u = r.length > 0;
                            u && (a && s ? (O.verbose("Selecting multiple", n, r), o.checkbox("uncheck"), e.each(n, function (e, t) {
                    ...
                    form: function (e) {
                        ...
                        var n = O.get.field(t.identifier), r = !0, o = [];
                        return n.prop("disabled") ? (O.debug("Field is disabled. Skipping", t.identifier), r = !0) : t.optional && "" === e.trim(n.val()) ? (O.debug("Field is optional and empty. Skipping", t.identifier), r = !0) : t.rules !== i && e.each(t.rules, function (e, n) {
                        ...
                        var i, r, o, a = O.get.field(t.identifier), s = n.type, l = a.val(), c = s.match(k.regExp.bracket), u = !0;
                        if (l = e.trim(a.val() + ""), c) {
                            if (r = "" + c[1], o = s.replace(c[0], ""), i = k.rules[o], !e.isFunction(i))return void O.error(S.noRule, o);
                            u = i.call(a, l, r)
                        } else {
                            if (i = k.rules[s], !e.isFunction(i))return void O.error(S.noRule, s);
                            u = i.call(a, l)
                        }
                        return u
                    }
                    ...
                    log: function (e) {
                        var t, n, i;
                        k.performance && (t = (new Date).getTime(), i = s || t, n = t - i, s = t, l.push({
                            Name: e[0],
                    ...
                    var a, s, l, c = T;
                    return n = n || d, o = D || o, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (n, r) {
        ...
        rules: {
            checked: function () {
                ...
                return n === i || "" === n || ".." === n || (-1 == n.indexOf("..") ? s.test(n) && (r = o = n - 0) : (a = n.split("..", 2), s.test(a[0]) && (r = a[0] - 0), s.test(a[1]) && (o = a[1] - 0))), s.test(t) && (r === i || t >= r) && (o === i || o >= t)
            }, is: function (e, t) {

            ...
            v = {
                initialize: function () {
                    ...
                    text: function (e) {
                        ...
                        return p.precision > 0 ? Math.round(10 * r * p.precision) / (10 * p.precision) : Math.round(r)
                    }, percent: function () {
                        return v.percent || 0
                    }, value: function () {
                        return v.value || 0
                    ...
                    log: function (e) {
                        var t, n, r;
                        p.performance && (t = (new Date).getTime(), r = s || t, n = t - r, s = t, c.push({
                            Name: e[0],
                    ...
                    var i, s, c, l = S;
                    return n = n || g, o = A || o, "string" == typeof t && l !== r && (t = t.split(/[\. ]/), i = t.length - 1, e.each(t, function (n, a) {

...
!function (e, o, n, t) {
    ...
    e.fn.nag = function (n) {
        ...
        return a.each(function () {
            {
                var a, d = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.nag.settings, n) : e.extend({}, e.fn.nag.settings), m = (d.className, d.selector), f = d.error, p = d.namespace, h = "." + p, b = p + "-module", v = e(this), y = (v.find(m.close), e(d.context ? d.context : "body")), k = this, w = v.data(b);
            ...
            a = {
                initialize: function () {
                    ...
                    set: function (n, i) {
                        ...
                        var r;
                        return "localstorage" == d.storageMethod && o.localStorage !== t ? r = o.localStorage.getItem(n) : e.cookie !== t ? r = e.cookie(n) : a.error(f.noCookieStorage), ("undefined" == r || "null" == r || r === t || null === r) && (r = t), r
                    }, remove: function (n) {
                    ...
                    var s, c, l, u = w;
                    return n = n || g, r = k || r, "string" == typeof o && u !== t && (o = o.split(/[\. ]/), s = o.length - 1, e.each(o, function (n, i) {

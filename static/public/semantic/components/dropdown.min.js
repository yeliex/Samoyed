        ...
        return s.each(function (h) {
            ...
            S = {
                initialize: function () {
                    ...
                    S.verbose("Destroying previous dropdown", E), S.remove.tabbable(), E.off(O).removeData(V), U.off(O), r.off(p), x && x.disconnect(), C && C.disconnect()
                    ...
                    }), S.has.input() && x.observe(z[0], {
                        childList: !0,
                        subtree: !0
                    }), S.has.menu() && C.observe(U[0], {
                        childList: !0,
                        subtree: !0
                    ...
                    id: function () {
                        ...
                        return (t = t || S.get.userValues()) ? (t = e.isArray(t) ? t : [t], e.each(t, function (t, s) {
                            S.get.item(s) === !1 && (o = y.templates.addition(s), a = e("<div />").html(o).data(k.value, s).addClass(A.addition).addClass(A.item), n = n === i ? a : n.add(a), S.verbose("Creating user choices for value", s, a))
                        }), n) : !1
                    ...
                    firstUnfiltered: function () {
                        ...
                        e = e.eq(0);
                        var t = e.nextAll(I.item).not(I.unselectable).eq(0), n = e.prevAll(I.item).not(I.unselectable).eq(0), i = t.length > 0;
                        i ? (S.verbose("Moving selection to", t), t.addClass(A.selected)) : (S.verbose("Moving selection to", n), n.addClass(A.selected))
                    }
                }, setup: {
                    api: function () {
                        var e = {debug: y.debug, on: !1};
                        S.verbose("First request, initializing API"), E.api(e)
                    }, layout: function () {
                        E.is("select") && (S.setup.select(), S.setup.returnedObject()), S.is.search() && !S.has.search() && (S.verbose("Adding search input"), M = e("<input />").addClass(A.search).insertBefore(P)), y.allowTab && S.set.tabbable(), 0 === U.length && (U = e("<div />").addClass(A.menu).appendTo(E))
                    }, select: function () {
                        var t = S.get.selectValues();
                        S.debug("Dropdown initialized on a select", t), E.is("select") && (z = E), z.parent(I.dropdown).length > 0 ? (S.debug("UI dropdown already exists. Creating dropdown menu only"), E = z.closest(I.dropdown), U = E.children(I.menu), S.setup.menu(t)) : (S.debug("Creating entire dropdown from select"), E = e("<div />").attr("class", z.attr("class")).addClass(A.selection).addClass(A.dropdown).html(q.dropdown(t)).insertBefore(z), z.removeAttr("class").detach().prependTo(E)), z.is("[multiple]") && S.set.multiple(), S.refresh()
                    }, menu: function (e) {
                    ...
                    S.verbose("Finding other dropdowns to hide"), s.not(E).has(I.menu + "." + A.visible).dropdown("hide")
                }, hideMenu: function () {
                    S.verbose("Hiding menu  instantaneously"), S.remove.active(), S.remove.visible(), U.transition("hide")
                }, hideSubMenus: function () {
                    var e = U.children(I.item).find(I.menu);
                    S.verbose("Hiding sub menus", e), e.transition("hide")
                }, bind: {
                    keyboardEvents: function () {
                        S.debug("Binding keyboard events"), E.on("keydown" + O, S.event.keydown), S.has.search() && E.on(S.get.inputEvent() + O, I.search, S.event.input), S.is.multiple() && r.on("keydown" + p, S.event.document.keydown)
                    }, touchEvents: function () {
                        S.debug("Touch device detected binding additional touch events"), S.is.searchSelection() || S.is.single() && E.on("touchstart" + O, S.event.test.toggle), U.on("touchstart" + O, I.item, S.event.item.mouseenter)
                        ...
                        S.verbose("Binding hide intent event to document"), c && r.on("touchstart" + p, S.event.test.touch).on("touchmove" + p, S.event.test.touch), r.on("click" + p, S.event.test.hide)
                    }
                }, unbind: {
                    intent: function () {
                        S.verbose("Removing hide intent event from document"), c && r.off("touchstart" + p).off("touchmove" + p), r.off("click" + p)
                    }
                }, filter: function (e) {
                    ...
                    var n = t !== i ? t : S.get.query(), a = e(), o = S.escape.regExp(n), s = new RegExp("^" + o, "igm");
                    "" === n ? a = N : (S.verbose("Searching for matching values", n), N.each(function () {
                        var t, i, o = e(this);
                        if ("both" == y.match || "text" == y.match) {
                            if (t = String(S.get.choiceText(o, !1)), -1 !== t.search(s))return a = a.add(o), !0;
                            if (y.fullTextSearch && S.fuzzySearch(n, t))return a = a.add(o), !0
                        }
                        if ("both" == y.match || "value" == y.match) {
                            if (i = String(S.get.choiceValue(o, t)), -1 !== i.search(s))return a = a.add(o), !0;
                            if (y.fullTextSearch && S.fuzzySearch(n, i))return a = a.add(o), !0
                        }
                    ...
                    var e = N.not(A.filtered).filter("." + A.selected).eq(0), t = N.not(A.filtered).filter("." + A.active).eq(0), n = e.length > 0 ? e : t, i = n.size() > 0;
                    i ? (S.debug("Forcing partial selection to selected item", n), S.event.item.click.call(n)) : S.hide()
                }, event: {
                    focus: function () {
                        y.showOnFocus && !K && S.is.hidden() && !b && S.show()
                    }, click: function (t) {
                        var n = e(t.target);
                        n.is(E) && !S.is.focusedOnSearch() && S.focusSearch()
                    }, blur: function (e) {
                        ...
                        click: function (t) {
                            var n = e(this), i = E.find(I.label), a = i.filter("." + A.active), o = n.nextAll("." + A.active), s = n.prevAll("." + A.active), r = o.length > 0 ? n.nextUntil(o).add(a).add(n) : n.prevUntil(s).add(a).add(n);
                            t.shiftKey ? (a.removeClass(A.active), r.addClass(A.active)) : t.ctrlKey ? n.toggleClass(A.active) : (a.removeClass(A.active), n.addClass(A.active)), y.onLabelSelect.apply(this, i.filter("." + A.active))
                        }
                    }, remove: {
                        click: function () {
                            var t = e(this).parent();
                        ...
                        mouseenter: function (t) {
                            var n = e(this).children(I.menu), i = e(this).siblings(I.item).children(I.menu);
                            ...
                            var n = e(this), i = e(t ? t.target : ""), a = n.find(I.menu), o = S.get.choiceText(n), s = S.get.choiceValue(n, o), r = a.length > 0, l = a.find(i).length > 0;
                        ...
                        if (i) {
                            ...
                            if (S.is.visible()) {
                                if ((t == n.enter || t == n.delimiter) && (t == n.enter && f && m && !y.allowCategorySelection ? (S.verbose("Pressed enter on unselectable category, opening sub menu"), t = n.rightArrow) : h && (S.verbose("Selecting item from keyboard shortcut", l), S.event.item.click.call(l, e), S.is.searchSelection() && S.remove.searchTerm()), e.preventDefault()), t == n.leftArrow && (o = d[0] !== U[0], o && (S.verbose("Left key pressed, closing sub-menu"), S.animate.hide(!1, d), l.removeClass(A.selected), d.closest(I.item).addClass(A.selected), e.preventDefault())), t == n.rightArrow && m && (S.verbose("Right key pressed, opening sub-menu"), S.animate.show(!1, u), l.removeClass(A.selected), u.find(I.item).eq(0).addClass(A.selected), e.preventDefault()), t == n.upArrow) {
                                    if (a = f && v ? l.prevAll(I.item + ":not(" + I.unselectable + ")").eq(0) : N.eq(0), c.index(a) < 0)return S.verbose("Up key pressed but reached top of current menu"), void e.preventDefault();
                                    S.verbose("Up key pressed, changing active item"), l.removeClass(A.selected), a.addClass(A.selected), S.set.scrollPosition(a), e.preventDefault()
                                }
                                if (t == n.downArrow) {
                                    if (a = f && v ? a = l.nextAll(I.item + ":not(" + I.unselectable + ")").eq(0) : N.eq(0), 0 === a.length)return S.verbose("Down key pressed but reached bottom of current menu"), void e.preventDefault();
                                    S.verbose("Down key pressed, changing active item"), N.removeClass(A.selected), a.addClass(A.selected), S.set.scrollPosition(a), e.preventDefault()
                                }
                    ...
                    selectAction: function (t, n) {
                        ...
                        var a = e(t.target), o = a.closest(n.documentElement).length > 0, s = a.closest(E).length > 0;
                        ...
                        var i = e(t.target), a = 0 === i.closest(I.siblingLabel).length, o = 0 === i.closest(U).length;
                        return n = e.isFunction(n) ? n : function () {
                        }, a && o ? (S.verbose("Triggering event", n), n(), !0) : (S.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    ...
                    id: function () {
                        ...
                        var e = S.get.value();
                        return "" === e ? "" : !z.is("select") && S.is.multiple() ? "string" == typeof e ? e.split(y.delimiter) : "" : e
                        ...
                        var t = {};
                        return t.values = [], E.find("option").each(function () {
                        ...
                        var e = N.not(I.unselectable).filter("." + A.selected);
                        return e.length > 0 ? e : N.eq(0)
                    }, itemWithAdditions: function (e) {
                        var t = S.get.item(e), n = S.create.userChoice(e), i = n && n.length > 0;
                        return i && (t = t.length > 0 ? t.add(n) : n), t
                    }, item: function (t, n) {
                        var a, o, s = !1;
                        return t = t !== i ? t : S.get.values() !== i ? S.get.values() : S.get.text(), a = o ? t.length > 0 : t !== i && "" !== t && null !== t, o = S.is.multiple() && e.isArray(t), n = "" === t || 0 === t ? !0 : n || !1, a && N.each(function () {
                            var a = e(this), r = S.get.choiceText(a), l = S.get.choiceValue(a, r);
                            if (null !== l && l !== i)if (o)(-1 !== e.inArray(l.toString(), t) || -1 !== e.inArray(r, t)) && (s = s ? s.add(a) : a); else if (n) {
                                if (S.verbose("Ambiguous dropdown value using strict type check", a, t), l === t || r === t)return s = a, !0
                            } else if (l.toString() == t.toString() || r == t)return S.verbose("Found select item by value", l, t), s = a, !0
                        }), s
                    }
                }, check: {
                    ...
                    defaults: function () {
                        ...
                        var e = E.data(k.defaultText);
                        S.debug("Restoring default text", e), S.set.text(e), P.addClass(A.placeholder)
                    }, defaultValue: function () {
                        var e = E.data(k.defaultValue);
                    ...
                    remoteData: function (e) {
                        var n;
                        return t.Storage === i ? void S.error(R.noStorage) : (n = sessionStorage.getItem(e), n !== i ? n : !1)
                    }
                }, save: {
                    defaults: function () {
                        ...
                        var e = S.get.value();
                        S.verbose("Saving default value as", e), E.data(k.defaultValue, e)
                    }, defaultText: function () {
                        var e = S.get.text();
                        S.verbose("Saving default text as", e), E.data(k.defaultText, e)
                    }, placeholderText: function () {
                        var e;
                        P.hasClass(A.placeholder) && (e = S.get.text(), S.verbose("Saving placeholder text as", e), E.data(k.placeholderText, e))
                    ...
                    var n, i, a, t = t || S.get.selectedItem(), o = t.closest(I.menu), s = o.outerHeight(), r = o.scrollTop(), l = N.eq(0).outerHeight(), c = Math.floor(s / l), u = (o.prop("scrollHeight"), "up" == e ? r - l * c : r + l * c), d = N.not(I.unselectable);
                    a = "up" == e ? d.index(t) - c : d.index(t) + c, n = "up" == e ? a >= 0 : a < d.length, i = n ? d.eq(a) : "up" == e ? d.first() : d.last(), i.length > 0 && (S.debug("Scrolling page", e, i), t.removeClass(A.selected), i.addClass(A.selected), o.scrollTop(u))
                }, set: {
                    filtered: function () {
                        ...
                        e && a && (S.verbose("Adjusting input width", o, y.glyphWidth), M.css("width", o)), a || n && s ? (S.verbose("Hiding placeholder text"), P.addClass(A.filtered)) : (!e || n && !s) && (S.verbose("Showing placeholder text"), P.removeClass(A.filtered))
                    }, loading: function () {
                        ...
                        e = e || S.get.selectedItem(), n = e.closest(I.menu), a = e && e.length > 0, t = t !== i ? t : !1, e && n.length > 0 && a && (s = e.position().top, n.addClass(A.loading), l = n.scrollTop(), r = n.offset().top, s = e.offset().top, o = l - r + s, t || (c = n.height(), d = o + v > l + c, u = l > o - v), S.debug("Scrolling to active item", o), (t || u || d) && n.scrollTop(o), n.removeClass(A.loading))
                    }, text: function (e) {
                        ...
                        var n, i = N.filter("." + A.selected), a = i.length > 0 && S.has.firstLetter(i, t), o = !1;
                        a && (n = i.nextAll(N).eq(0), S.has.firstLetter(n, t) && (o = n)), o || N.each(function () {
                            return S.has.firstLetter(e(this), t) ? (o = e(this), !1) : void 0
                        }), o && (S.verbose("Scrolling to next value with letter", t), S.set.scrollPosition(o), i.removeClass(A.selected), o.addClass(A.selected))
                        ...
                        var i = z.length > 0, a = (!S.has.value(e), S.get.values()), o = "number" == typeof e ? e.toString() : e;
                        if (i) {
                            if (o == a && (S.verbose("Skipping value update already same value", e, a), !S.is.initialLoad()))return;
                            S.debug("Updating input value", e, a), z.val(e).trigger("change")
                        } else S.verbose("Storing value in metadata", e, z), e !== a && E.data(k.value, e);
                        y.fireOnInit === !1 && S.is.initialLoad() ? S.verbose("No callback on initial load", y.onChange) : y.onChange.call(B, e, t, n)
                    }, active: function () {
                        E.addClass(A.active)
                    }, multiple: function () {
                        ...
                        n = y.allowAdditions ? n || S.get.itemWithAdditions(t) : n || S.get.item(t), n && (S.debug("Setting selected menu item to", n), S.is.single() ? (S.remove.activeItem(), S.remove.selectedItem()) : y.useLabels && S.remove.selectedItem(), n.each(function () {
                            var t = e(this), a = S.get.choiceText(t), o = S.get.choiceValue(t, a), s = t.hasClass(A.filtered), r = t.hasClass(A.active), l = t.hasClass(A.addition), c = i && 1 == n.length;
                    ...
                    label: function (t, n, i) {
                        var a, o = S.is.searchSelection() ? M : P;
                        return a = e("<a />").addClass(A.label).attr("data-value", t).html(q.label(t, n)), a = y.onLabelCreate.call(a, t, n), S.has.label(t) ? void S.debug("Label already exists, skipping", t) : (y.label.variation && a.addClass(y.label.variation), void(i === !0 ? (S.debug("Animating in label", a), a.addClass(A.hidden).insertBefore(o).transition(y.label.transition, y.label.duration)) : (S.debug("Adding selection label", a), a.insertBefore(o))))
                    }, message: function (t) {
                        var n = U.children(I.message), i = y.templates.message(S.add.variables(t));
                        n.length > 0 ? n.html(i) : n = e("<div/>").html(i).addClass(A.message).appendTo(U)
                    }, optionValue: function (t) {
                        var n = z.find('option[value="' + t + '"]'), i = n.length > 0;
                        i || (x && (x.disconnect(), S.verbose("Temporarily disconnecting mutation observer", t)), e("<option/>").prop("value", t).html(t).appendTo(z), S.verbose("Adding user addition as an <option>", t), x && x.observe(z[0], {
                            childList: !0,
                            subtree: !0
                        }))
                    }, userSuggestion: function (e) {
                        var t, n = U.children(I.addition), i = S.get.item(e), a = n.length > 0;
                        if (!S.has.maxSelections()) {
                            if ("" === e || i)return void n.remove();
                            N.removeClass(A.selected), a ? (t = y.templates.addition(e), n.html(t).data(k.value, e).removeClass(A.filtered).addClass(A.selected), S.verbose("Replacing user suggestion with new value", n)) : (n = S.create.userChoice(e), n.prependTo(U).addClass(A.selected), S.verbose("Adding item choice to menu corresponding with user choice addition", n))
                        }
                    }, variables: function (e) {
                        var t, n, i = -1 !== e.search("{count}"), a = -1 !== e.search("{maxCount}"), o = -1 !== e.search("{term}");
                        return S.verbose("Adding templated variables to message", e), i && (t = S.get.selectionCount(), e = e.replace("{count}", t)), a && (t = S.get.selectionCount(), e = e.replace("{maxCount}", y.maxSelections)), o && (n = S.get.query(), e = e.replace("{term}", n)), e
                    }, value: function (t, n, i) {
                        var a, o = S.get.values();
                        return "" === t ? void S.debug("Cannot select blank values from multiselect") : (e.isArray(o) ? (a = o.concat([t]), a = S.get.uniqueArray(a)) : a = [t], z.is("select") ? y.allowAdditions && (S.add.optionValue(t), S.debug("Adding value to select", t, a, z)) : (a = a.join(y.delimiter), S.debug("Setting hidden input to delimited value", a, z)), y.fireOnInit === !1 && S.is.initialLoad() ? S.verbose("No callback on initial load", y.onAdd) : y.onAdd.call(B, t, n, i), S.set.value(a, t, n, i), void S.check.maxSelections())
                    }
                }, remove: {
                    active: function () {
                        ...
                        return (n = y.allowAdditions ? n || S.get.itemWithAdditions(t) : n || S.get.item(t)) ? void n.each(function () {
                            ...
                            S.is.multiple() ? y.useLabels ? (S.remove.value(i, n, t), S.remove.label(i)) : (S.remove.value(i, n, t), S.set.text(S.add.variables(T.count))) : S.remove.value(i, n, t), t.removeClass(A.filtered).removeClass(A.active), y.useLabels && t.removeClass(A.selected)
                        }) : !1
                    }, selectedItem: function () {
                        N.removeClass(A.selected)
                    }, value: function (e, t, n) {
                        var i, a = z.val();
                        z.is("select") ? (S.verbose("Input is <select> removing selected option", e), i = S.remove.arrayValue(e, a)) : (S.verbose("Removing from delimited values", e), a = a.split(y.delimiter), i = S.remove.arrayValue(e, a), i = i.join(y.delimiter)), y.fireOnInit === !1 && S.is.initialLoad() ? S.verbose("No callback on initial load", y.onRemove) : y.onRemove.call(B, e, t, n), S.set.value(i, t, n), S.check.maxSelections()
                    }, arrayValue: function (t, n) {
                        return n = e.grep(n, function (e) {
                            return t != e
                        }), S.verbose("Removed value from delimited string", t, n), n
                    }, label: function (e) {
                        var t = E.find(I.label), n = t.filter('[data-value="' + e + '"]'), i = t.length, a = t.index(n) + 1 == i, o = (!S.is.searchSelection() || !S.is.focusedOnSearch()) && a;
                        o ? (S.verbose("Animating and removing label", n), n.transition(y.label.transition, y.label.duration, function () {
                            n.remove()
                        ...
                        t = t || E.find(I.label), S.verbose("Removing labels", t), t.each(function () {
                            var t = e(this).data("value"), n = S.is.userValue(t);
                            n ? (S.remove.value(t), S.remove.label(t)) : S.remove.selected(t)
                        })
                    }, tabbable: function () {
                    ...
                    active: function () {
                        ...
                        var t, n = e || U, i = !0, a = {};
                        return n.addClass(A.loading), t = {
                            context: {scrollTop: F.scrollTop(), height: F.outerHeight()},
                        ...
                        }, a.below ? (S.verbose("Dropdown can fit in context downward", a), i = !0) : a.below || a.above ? (S.verbose("Dropdown cannot fit below, opening upward", a), i = !1) : (S.verbose("Dropdown cannot fit in either direction, favoring downward", a), i = !0), n.removeClass(A.loading), i
                    ...
                    show: function (t, n) {
                        var a, o = n || U, s = n ? function () {
                        } : function () {
                            S.hideSubMenus(), S.hideOthers(), S.set.active()
                        };
                        t = e.isFunction(t) ? t : function () {
                        }, S.verbose("Doing menu show animation", o), S.set.direction(n), a = S.get.transition(n), S.is.selection() && S.set.scrollPosition(S.get.selectedItem(), !0), (S.is.hidden(o) || S.is.animating(o)) && ("none" == a ? (s(), o.transition("show"), t.call(B)) : e.fn.transition !== i && E.transition("is supported") ? o.transition({
                            animation: a + " in",
                            debug: y.debug,
                            verbose: y.verbose,
                            duration: y.duration,
                        ...
                        var a = n || U, o = (n ? .9 * y.duration : y.duration, n ? function () {
                        } : function () {
                            S.can.click() && S.unbind.intent(), S.remove.active()
                        }), s = S.get.transition(n);
                        t = e.isFunction(t) ? t : function () {
                        }, (S.is.visible(a) || S.is.animating(a)) && (S.verbose("Doing menu hide animation", a), "none" == s ? (o(), a.transition("hide"), t.call(B)) : e.fn.transition !== i && E.transition("is supported") ? a.transition({
                            animation: s + " out",
                            duration: y.duration,
                            debug: y.debug,
                            verbose: y.verbose,
                    ...
                    var s, r, l, c = $;
                    return n = n || f, a = B || a, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (n, a) {
                        var o = n != s ? a + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
                        if (e.isPlainObject(c[o]) && n != s)c = c[o]; else {
                            if (c[o] !== i)return r = c[o], !1;
                            if (!e.isPlainObject(c[a]) || n == s)return c[a] !== i ? (r = c[a], !1) : (S.error(R.method, t), !1);
                            c = c[a]
                        }

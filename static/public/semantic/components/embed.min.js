...
!function (e, n, o, r) {
    ...
    e.fn.embed = function (o) {
        ...
        return a.each(function () {
            var m, p = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.embed.settings, o) : e.extend({}, e.fn.embed.settings), f = p.selector, h = p.className, g = p.sources, b = p.error, v = p.metadata, y = p.namespace, w = p.templates, C = "." + y, P = "module-" + y, U = (e(n), e(this)), E = U.find(f.placeholder), S = U.find(f.icon), T = U.find(f.embed), j = this, A = U.data(P);
            m = {
                initialize: function () {
                    ...
                    autoplay: function () {
                        ...
                        var o = !1;
                        return n = n || m.get.url(), n && e.each(g, function (e, r) {
                            return -1 !== n.search(r.domain) ? (o = e, !1) : void 0
                        }), o
                    }, icon: function () {
                        var e = m.get.source();
                        return g[e] !== r ? g[e].icon : !1
                    }, url: function () {
                        var e, n = p.id || U.data(v.id), o = p.source || U.data(v.source);
                        return e = g[o] !== r ? g[o].url.replace("{id}", n) : !1, e && U.data(v.url, e), e
                    }
                }, set: {
                    active: function () {
                        U.addClass(h.active)
                    ...
                    embed: function (e) {
                        ...
                        return e = m.get.url(e), e ? (o = m.generate.parameters(r), n = w.iframe(e, o)) : m.error(b.noURL, U), n
                    }, parameters: function (n, o) {
                        var t = g[n] && g[n].parameters !== r ? g[n].parameters(p) : {};
                    ...
                    return o = o || s, a = j || a, "string" == typeof n && d !== r && (n = n.split(/[\. ]/), i = n.length - 1, e.each(n, function (o, t) {
                        ...
                        if (e.isPlainObject(d[a]) && o != i)d = d[a]; else {
                            ...
                            if (!e.isPlainObject(d[t]) || o == i)return d[t] !== r ? (c = d[t], !1) : (m.error(b.method, n), !1);
                            d = d[t]
                        }

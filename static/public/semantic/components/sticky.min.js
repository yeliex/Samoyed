...
!function (e, t, o, n) {
    ...
    e.fn.sticky = function (o) {
        var i, s = e(this), r = s.selector || "", c = (new Date).getTime(), l = [], a = arguments[0], m = "string" == typeof a, f = [].slice.call(arguments, 1);
        return s.each(function () {
            ...
            h = {
                initialize: function () {
                    ...
                    }), d.observe(z, {childList: !0, subtree: !0}), d.observe(e, {
                        childList: !0,
                        subtree: !0
                    ...
                    lastScroll: function (e) {
                    ...
                    }, positions: function () {
                        {
                            var e = {height: y.height()}, t = {
                                ...
                                bottomPadding: parseInt(u.css("padding-bottom"), 10)
                            };
                    ...
                    direction: function (e) {
                        ...
                        e = e || k.scrollTop();
                        var t = h.cache.element, o = h.cache.window, n = h.get.scrollChange(e), i = t.height - o.height + g.offset, s = h.get.currentElementScroll(), r = s + n;
                    ...
                    offset: function () {
                        ...
                        0 !== h.cache.element.height && 0 !== h.cache.element.width && S.css({
                            width: h.cache.element.width,
                            height: h.cache.element.height
                        })
                    }
                }, is: {
                    top: function () {
                    ...
                    h.debug("Fixing element to top of page"), h.set.minimumSize(), h.set.offset(), S.css({
                        ...
                        bottom: "",
                        marginBottom: ""
                    }).removeClass(b.bound).removeClass(b.bottom).addClass(b.fixed).addClass(b.top), g.onStick.call(z)
                }, fixBottom: function () {
                    h.debug("Sticking element to bottom of page"), h.set.minimumSize(), h.set.offset(), S.css({
                        left: h.cache.element.left,
                        bottom: "",
                        marginBottom: ""
                    }).removeClass(b.bound).removeClass(b.top).addClass(b.fixed).addClass(b.bottom), g.onStick.call(z)
                }, unbind: function () {
                    ...
                    log: function (e) {
                        var t, o, n;
                        g.performance && (t = (new Date).getTime(), n = c || t, o = t - n, c = t, l.push({
                            Name: e[0],
                        ...
                        var t = g.name + ":", o = 0;
                        c = !1, clearTimeout(h.performance.timer), e.each(l, function (e, t) {
                            o += t["Execution Time"]
                    ...
                    var r, c, l, a = w;
                    return o = o || f, s = z || s, "string" == typeof t && a !== n && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (o, i) {

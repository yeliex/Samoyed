function QiniuJsSDK() {
    ...
    this.uploader = function (b) {
        ...
        plupload.extend(c, b, {url: "http://upload.qiniu.com", multipart_params: {token: ""}});
        ...
        return j.bind("Init", function (a, b) {
            ...
            var e = function (c, d, e) {
                ...
                c.setOption({url: "http://upload.qiniu.com/", multipart: !0, chunk_size: void 0, multipart_params: f})
            ...
            if (g = g || c.settings && c.settings.chunk_size, "html5" === j.runtime && g)if (d.size < g)e(c, d, a.key_handler); else {
                ...
                if (h) {
                    ...
                    n > l - m && 100 !== h.percent && d.size === h.total ? (d.percent = h.percent, d.loaded = h.offset, f = h.ctx, h.offset + k > d.size && (k = d.size - h.offset)) : localStorage.removeItem(d.name)
                }
                c.setOption({
                    url: "http://upload.qiniu.com/mkblk/" + k,
                    multipart: !1,
                    chunk_size: g,
            ...
            h = h || b.settings && b.settings.chunk_size, h > g && b.setOption({url: "http://upload.qiniu.com/mkblk/" + g}), localStorage.setItem(c.name, JSON.stringify({
                ctx: f,
                percent: c.percent,
                total: d.total,
                offset: d.offset,
            ...
            return function (d, e, g) {
                ...
                if (f = f ? f : k.ctx) {
                    ...
                    var q = "http://upload.qiniu.com/mkfile/" + e.size + l + o, r = a.createAjax();

...
function dataSend(c) {
    var a;
    var b = $.ajax("http://api.mzapp.info/appointuser/userSave?protocol=json", {
        method: "POST",
        async: false,
        data: c
    });
...
function registerFailed(b) {
    var a = $.ajax("http://api.mzapp.info/appointuser/registerFailed?protocol=json", {
        method: "POST",
        async: false,
        data: {id: b}
    });
...
function logout() {
    var a = $.ajax("http://api.mzapp.info/appointuser/userLogout", {
        method: "GET",
        async: false,
        data: {protocol: "json"}
    });
...
function getUserInfo(a) {
    var c;
    var b = $.ajax("http://api.mzapp.info/appointuser/userInfo", {
        method: "GET",
        async: false,
